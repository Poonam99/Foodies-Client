...
const EditREview = () => {
    ...
    const dataUpdate = event => {
        ...
        fetch(`https://food-service-app-server.vercel.app/reviews/${data._id}`, {
            method: 'PATCH',
            headers: {
                    ...
                    <div className="card flex-shrink-0 p-4 w-full max-w-sm shadow-2xl bg-base-100">
                        ...
                        <form onSubmit={dataUpdate} className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <input type="text" name='rating' defaultValue={data.rating} className="input input-bordered"
                                    required />
                            </div>
                            <div className="form-control">
                                <label className="label">
                                ...
                                <input type="text" name='des' defaultValue={data.description} className="input input-bordered"
                                    required />
                            </div>
