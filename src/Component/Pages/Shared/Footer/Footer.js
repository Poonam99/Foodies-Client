    ...
    return (
        <footer className="dark:bg-black dark:text-White">
            <div className="container flex justify-between flex-col p-4 mx-auto md:p-8 lg:flex-row ">
                <div>
                    <ul className="self-center py-6  text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start">
                        <li>Shop</li>
                        <li>About</li>
                        <li>Blog</li>
                        <li>Pricing</li>
                ...
                <div className='flex justify-center items-center'>
                    <span>©2022 Foodies</span>
                </div>

                <div className="flex items-center justify-between pt-6 lg:pt-0">
